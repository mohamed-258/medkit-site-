  ...
  return (
    <header className="h-20 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 fixed top-0 right-0 left-0 lg:left-64 z-40 px-4 sm:px-8 flex items-center justify-between transition-all duration-300">
      ...
      <div className="flex items-center gap-3 sm:gap-6 ml-auto sm:ml-0">
        <button className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-5 sm:px-6 py-2.5 rounded-full text-xs sm:text-sm font-black shadow-xl shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-0.5 transition-all active:scale-95">
          <Plus size={18} />
          <span className="hidden xs:inline">Start New Quiz</span>
          <span className="xs:hidden">New Quiz</span>
        </button>

        <div className="flex items-center gap-3 sm:gap-4 pl-3 sm:pl-6 border-l border-slate-100 dark:border-slate-800">
